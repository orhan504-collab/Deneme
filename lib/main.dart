...
class _RandevuSayfasiState extends State<RandevuSayfasi> {
  ...
  Future<void> randevuKaydet() async {
    ...
    try {
      // Veritabanına Yazma (Tablo adı: RuyamDB)
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: <String>['Fön', 'Boya', 'Kesim', 'Makyaj'].map((v) => DropdownMenuItem(value: v, child: Text(v))).toList(),
              ),
              const SizedBox(height: 25),
              SizedBox(
                width: double.infinity,
                height: 50,
                child: ElevatedButton(onPressed: randevuKaydet, style: ElevatedButton.styleFrom(backgroundColor: Colors.pink), child: const Text('Randevu Al', style: TextStyle(color: Colors.white))),
              ),
            ],
          ),
        ),
